...
class MoveBaseSquare():
    ...
    def __init__(self):
        ...
        self.waypoints.append(Pose(Point(square_size, 0.0, 0.0), quaternions[0]))
        self.waypoints.append(Pose(Point(square_size, square_size, 0.0), quaternions[1]))
        self.waypoints.append(Pose(Point(0.0, square_size, 0.0), quaternions[2]))
       ...
       ################
        ...
        self.service = rospy.Service('move_base_square', MoveBaseSquareCommand, self.move_square)
        print "Ready to move in square..."
        rospy.spin()
